...
<dependency>
    <groupId>com.sreenidhi-gsd</groupId>
    <artifactId>arachnid-extension</artifactId>
    <version>0.7.3</version>
</dependency>
```
        
Arachnid use slf4j with slf4j-log4j12 implementation. If you customized your slf4j implementation, please exclude slf4j-log4j12.
