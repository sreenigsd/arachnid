...
import com.gsd.sreenidhi.arachnid.selector.Selectable;
...
public class HtmlTest {
	...
	public void testGetHrefsByJsoup(){
		Html html = new Html("<html><a href='issues'>issues</a><img src='arachnid.jpg'/></html>","https://github.com/sreenigsd/arachnid/");
		assertThat(html.xpath("//a[1]/@abs:href").get()).isEqualTo("https://github.com/sreenigsd/arachnid/issues");
		assertThat(html.xpath("//img/@abs:src").get()).isEqualTo("https://github.com/sreenigsd/arachnid/arachnid.jpg");
		html = new Html("<html><base href='https://github.com/sreenigsd/arachnid/'><a href='issues'>issues</a><img src='arachnid.jpg'/></base></html>");
		assertThat(html.xpath("//a[1]/@abs:href").get()).isEqualTo("https://github.com/sreenigsd/arachnid/issues");
		assertThat(html.xpath("//img/@abs:src").get()).isEqualTo("https://github.com/sreenigsd/arachnid/arachnid.jpg");
	}
}
