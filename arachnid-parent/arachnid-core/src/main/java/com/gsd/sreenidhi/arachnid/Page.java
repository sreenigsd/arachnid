...
import com.gsd.sreenidhi.arachnid.selector.Json;
 ...
 * {@link #getResultItems()} get extract results to be used in {@link com.gsd.sreenidhi.arachnid.pipeline.Pipeline}<br>
 * {@link #addTargetRequests(java.util.List)} {@link #addTargetRequest(String)} add urls to fetch                 <br>
 *
 * @author sreenidhi.gsd@gmail.com <br>
 * @see com.gsd.sreenidhi.arachnid.downloader.Downloader
 * @see com.gsd.sreenidhi.arachnid.processor.PageProcessor
 */
public class Page {
